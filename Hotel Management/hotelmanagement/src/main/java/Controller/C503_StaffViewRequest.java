 ...
 * @author leeki
 */
@WebServlet(name = "C503_StaffViewRequest", urlPatterns = {"/C503_StaffViewRequest"})
public class C503_StaffViewRequest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("/hotelmanagement/Staff/StaffViewRequest.jsp");
