    ...
    <body onload="checkLogin()">
        ...
        <div style="margin-top: 20px; margin-right: 150px; margin-left: 150px">
            <table id ="table" class="ui large celled striped table">
                ...
                <form action="/hotelmanagement/C504_ManagerViewRequest" method="GET">   
                    <td>
                        <button class ="ui brown button" type="submit" name="viewRequest" value="<%=allBooking.get(i)%>">View Request</button>
                    </td>
                </form>
                </tr>
                <%}%>
